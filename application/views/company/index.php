        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Administrar la información de la compañía</h3>
            </div>
            <form role="form" action="<?php base_url('company/update') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="service_charge_value">Importe de cobro (%)</label>
                ...
                <div class="form-group">
                  <label for="vat_charge_value">Cargo de iva (%)</label>
