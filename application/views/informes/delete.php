    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <h1>¿Realmente quieres borrar el informe?</h1>

          <form action="<?php echo base_url('informes/delete/'.$id) ?>" method="post">
            <input type="submit" class="btn btn-primary" name="confirm" value="Confirm">
            <a href="<?php echo base_url('informes') ?>" class="btn btn-warning">Cancelar</a>
          </form>
