          ...
          <form role="form" action="<?php base_url('inventario/create') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="marca" name="marca" placeholder="" autocomplete="off" />
                </div>

                <div class="form-group">
                  <label for="modelo">Modelo</label>
                  <input type="text" class="form-control" id="modelo" name="modelo" placeholder="" autocomplete="off" />
                </div>

                <div class="form-group">
                  <label for="descripcion">Descripción</label>
                  <textarea type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Ingresa una descripción" autocomplete="off"></textarea>
                </div>

                <div class="form-group">
                  <label for="barras">Código de barras</label>
                  <input type="text" class="form-control" id="barras" name="barras" placeholder="Código de barras" autocomplete="off">
                </div>
                <div class="form-group">
                  <label for="serie">Número de serie</label>
                  <input type="text" class="form-control" id="serie" name="serie" placeholder="Código de barras" autocomplete="off">
                </div>
                <div class="form-group">
                  <label for="importe">Importe(sin impuestos)</label>
                  <input type="text" class="form-control" id="importe" name="importe" placeholder="Código de barras" autocomplete="off">
                </div>
